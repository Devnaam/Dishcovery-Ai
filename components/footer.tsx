...
import { Utensils, Instagram, Youtube, Github, Heart } from "lucide-react"
    ...
    <footer className="border-t bg-background mt-12">
      <div className="container px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm mt-4 flex items-center gap-1">
              Made with <Heart className="h-3.5 w-3.5 text-red-500 fill-red-500" /> & AI
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cuisines" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Explore Cuisines
                </Link>
              </li>
              <li>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">© 2025 Dishcovery. All rights reserved.</p>
